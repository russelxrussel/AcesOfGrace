<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="ItemStockSetup.aspx.cs" Inherits="AGC.ItemStockSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header bg-info"><h5><span class="fas fa-truck-loading text-warning"></span> Item Stock Setup</h5></div>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:GridView runat="server" ID="gvItems" CssClass="table table-hover table-sm table-responsive-md" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="50%"  HeaderText="Minimum Level Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtStockLevelWarning" MaxLength="6" Text='<%# Bind("tStockLevelWarning") %>' CssClass="form-control text-center" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
