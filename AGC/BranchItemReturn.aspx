<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="BranchItemReturn.aspx.cs" Inherits="AGC.BranchItemReturn" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header bg-info"><h5><span class="fas fa-truck-loading text-warning"></span> Branch Item Return</h5></div>
                <div class="card-body">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:GridView runat="server" ID="gvItems" CssClass="table table-hover table-sm table-responsive-md" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="50%" ControlStyle-CssClass="text-center" HeaderText="Return Qty">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtReturnItem" MaxLength="6" CssClass="form-control text-center" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <hr />
                                    <asp:TextBox runat="server" ID="txtRemarks" CssClass="form-control" TextMode="MultiLine" Rows="2" placeholder="Stock Return Remarks/Notes"></asp:TextBox>
