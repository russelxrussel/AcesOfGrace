<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="InventoryConsumeStock.aspx.cs" Inherits="AGC.InventoryConsumeStock" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header"><h5><span class="fas fa-box-open text-warning"></span> Stock Usage</h5></div>
                <div class="card-body">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                     <div class="input-group">
                                        <asp:TextBox runat="server" ID="txtConsumeDate" CssClass="form-control is-invalid calendarInput" placeholder="Date Usage"></asp:TextBox>    
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:GridView runat="server" ID="gvItems" CssClass="table table-hover table-sm table-responsive-md" GridLines="Horizontal" AutoGenerateColumns="false">
                                     ...
                                     <hr />
                                    Stock Usage Info:
                                    <asp:GridView runat="server" ID="gvStockUsageDone" CssClass="table table-sm table-responsive-md table-info" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:BoundField DataField="consumeNum" HeaderText="Reference" />
                                            <asp:BoundField DataField="ItemName" HeaderText="Item" />
                                            <asp:BoundField DataField="Quantity" HeaderText="Usage Qty" ControlStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="consumeDate" HeaderText="Date" DataFormatString="{0:d}" ControlStyle-Font-Bold="true" />
