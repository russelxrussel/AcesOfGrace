...
namespace AGC
{
    public partial class repDeliverySummary : System.Web.UI.Page
    {
        ...
        private void displayReport()
        {
            ...
            {
                oReportDocument.Load(Server.MapPath("~/Reports/repBranchDeliverySummary.rpt"));
                oReportDocument.SetParameterValue("paramBranchCode", ddBranchList.SelectedValue);
            }
            else
            {
                oReportDocument.Load(Server.MapPath("~/Reports/repDeliverySummaryTotal.rpt"));
            }
