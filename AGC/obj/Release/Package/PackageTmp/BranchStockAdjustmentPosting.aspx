<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="BranchStockAdjustmentPosting.aspx.cs" Inherits="AGC.BranchStockAdjustmentPosting" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header bg-primary"><h5><span class="fas fa-trash text-warning"></span> Stock Adjustment Posting</h5></div>
                <div class="card-body">
                            ...
                            <ul class="list-group">
                                ...
                                <li class="list-group-item">
                                 ...
                                 <div class="input-group-append">
                                    ...
                                    <asp:GridView runat="server" ID="gvAdjustmentForPostingList" ShowHeader="true" CssClass="table table-sm table-responsive-md table-hover" GridLines="Horizontal" AutoGenerateColumns="false" OnRowCommand="gvAdjustmentForPostingList_RowCommand">
                                        <Columns>
                                            <asp:BoundField DataField="StockAdjustmentNum" HeaderText="Reference Num"/>
                                            <asp:BoundField DataField="AdjustmentName" HeaderText="Partner"/>
                                            <asp:BoundField DataField="BranchCode" HeaderText="Code" />
                                            <asp:BoundField DataField="BranchName" HeaderText="Branch" />
                                            
                                            <asp:BoundField DataField="AdjustmentDate" DataFormatString="{0:d}" HeaderText="Delivery Date"/>


                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                 
                                                 <asp:LinkButton runat="server" ID="lnkView" CssClass="btn btn-sm btn-outline-warning" CommandName="View"><span class="fas fa-file-alt" data-toggle="tooltip" data-placement="top" title="View Adjustment Details"></span></asp:LinkButton>
                                                 <asp:LinkButton runat="server" ID="lnkPost" CssClass="btn btn-sm btn-outline-success" CommandName="Post"><span class="fas fa-upload" data-toggle="tooltip" data-placement="top" title="Post Adjustment"></span></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                             <asp:TemplateField>
                                                <ItemTemplate>
                                                  <asp:LinkButton runat="server" ID="lnkCancel" CssClass="btn btn-sm btn-outline-danger" CommandName="CancelAdjustment"><span class="fas fa-minus-circle" data-toggle="tooltip" data-placement="top" title="Cancel Adjustment"></span></asp:LinkButton>
                                               </ItemTemplate>
                                            </asp:TemplateField>
                ...
                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <asp:LinkButton runat="server" ID="LinkButton3" CssClass="btn btn-dark" Text="Close" data-dismiss="modal"></asp:LinkButton>
