<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="BranchSales.aspx.cs" Inherits="AGC.BranchSales" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header bg-success"><h5><span class="fas fa-shopping-cart text-warning"></span> Branch Sales</h5></div>
                <div class="card-body">
                            ...
                            <ul class="list-group">
                                <li class="list-group-item">
                                     <div class="input-group">
                                        <asp:TextBox runat="server" ID="txtSalesDate" CssClass="form-control is-invalid calendarInput" placeholder="Sales Date"></asp:TextBox>    
                                       <%-- <div class="input-group-append">
                                            <asp:LinkButton runat="server" ID="lnkSearchDate" CssClass="btn btn-outline-primary btn-sm"
                                                data-toggle="tooltip" data-placement="bottom" title="Sales Date"><span class="fas fa-play-circle"></span></asp:LinkButton>
                                    </div>--%>
                                              </div>
                                </li>
                                <li class="list-group-item">
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:GridView runat="server" ID="gvItems" CssClass="table table-hover table-sm table-responsive-md" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="50%" ControlStyle-CssClass="text-center" HeaderText="Qty Used">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtConsumeStock" MaxLength="6" CssClass="form-control text-center" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>

                                            <asp:TemplateField ControlStyle-Width="50%" ControlStyle-CssClass="text-center" HeaderText="Available">
                                                <ItemTemplate>
                                                    <b><asp:Label runat="server" ID="lblAvailableStock" Text='<%# Eval("tStockBalance") %>'></asp:Label></b>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                    ...
                                    <hr />
                                    Sales Info:
                                    <asp:GridView runat="server" ID="gvItemSalesDone" CssClass="table table-sm table-responsive-md table-info" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:BoundField DataField="salesNum" HeaderText="Reference" />
                                            <asp:BoundField DataField="ItemName" HeaderText="Item" />
                                            <asp:BoundField DataField="Quantity" HeaderText="Sales" ControlStyle-Font-Bold="true" />
                                            <asp:BoundField DataField="salesDate" HeaderText="Sales Date" DataFormatString="{0:d}" ControlStyle-Font-Bold="true" />
             ...
             <div class="modal fade bd-example-modal-lg" id="modalError" tabindex="-1" role="dialog" aria-labelledby="modalErrorLabel" aria-hidden="true">
                ...
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                   <h5><b><span class="fas fa-exclamation-circle text-danger"></span></b> <asp:Label runat="server" ID="lblSuccessMessage"></asp:Label></h5>
