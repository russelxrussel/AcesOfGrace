<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="ItemBranchPriceSetup.aspx.cs" Inherits="AGC.ItemBranchPriceSetup" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="contentPage" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="upMain" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <div class="card">
                <div class="card-header bg-info"><h5><span class="fas fa-truck-loading text-warning"></span>  Branch Item Price Setup</h5></div>
                <div class="card-body">
                                 ...
                                 <div class="input-group-append">
                                    ...
                                    <asp:GridView runat="server" ID="gvBranchList" ShowHeader="false" CssClass="table table-sm table-responsive-md table-hover" GridLines="Horizontal" AutoGenerateColumns="false" OnRowCommand="gvScheduleBranch_RowCommand">
                                        <Columns>
                                            ...
                                            <asp:TemplateField>
                                                <ItemTemplate>
                                                 <asp:LinkButton runat="server" ID="lnkDisplay" CssClass="btn btn-sm btn-outline-primary" CommandName="Select"><span class="fas fa-arrow-alt-circle-right" data-toggle="tooltip" data-placement="top" title="Insert Quantity"></span></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                        ...
                        <div class="col-md-8">
                            <div class="card">
                                <div class="card-header">
                                          <div class="row">
                                              <div class="col-md-8">
                                                   <span class="fas fa-store text-warning"></span> <asp:Label runat="server" ID="lblBranchName"></asp:Label>
                                              </div>
                                ...
                                <div class="card-body">
                                    ...
                                    <asp:GridView runat="server" ID="gvItems" CssClass="table table-hover table-sm table-responsive-md" GridLines="Horizontal" AutoGenerateColumns="false">
                                        <Columns>
                                            ...
                                            <asp:TemplateField ControlStyle-Width="50%"  HeaderText="Cost Price">
                                                <ItemTemplate>
                                                    <asp:TextBox runat="server" ID="txtBranchPrice" MaxLength="6" Text='<%# Bind("branchPrice") %>' CssClass="form-control text-center" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
