            ...
            <asp:Panel runat="server" ID="panelItemInput" Visible="true">
                    ...
                    <div class="form-row">
                         ...
                         <div class="form-group col-md-4">
                            ...
                            <asp:TextBox runat="server" ID="txtUnitCost" CssClass="form-control is-invalid" placeholder="Unit Cost" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                        </div>
                       

                         <div class="form-group col-md-4">
                        <label for="txtRemarks">Unit Price:</label>
                        <asp:TextBox runat="server" ID="txtUnitPrice" CssClass="form-control is-invalid" placeholder="Unit Price" onkeypress="return(event.charCode == 8 || event.charCode == 0) ? 0: event.charCode >= 46 && event.charCode <=57"></asp:TextBox>
                    </div>
                    </div>
