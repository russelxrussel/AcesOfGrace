<%@ Page Title="" Language="C#" MasterPageFile="~/AGC.Master" AutoEventWireup="true" CodeBehind="repSalesSummary.aspx.cs" Inherits="AGC.repSalesSummary" %>
...
<!-- Start of Markup here -->
              <div class="card">
                <div class="card-header bg-light"><h5><span class="fas fa-print text-warning"></span> Sales Summary Reports</h5></div>
                <div class="card-body">
                    <div class="row">
                        <!--Selection area here -->
                        <div class="col-md-3">
